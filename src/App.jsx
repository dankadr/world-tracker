      ...
      {isDataLoading ? (
        ...
        <>
                    ...
                    <div className="sheet-peek-progress">
                      <div
                        ...
                        style={{
                          ...
                          background: 'linear-gradient(90deg, #2B7A8C, #4DAEC0)',
                        }}
                      />
                    </div>
          ...
          >
            ...
            {!isMobile && (
              <div className="floating-stats world-floating-stats" style={{ '--accent': '#4DAEC0' }}>
                ...
                <p className="stats-pct" style={{ color: '#4DAEC0' }}>
